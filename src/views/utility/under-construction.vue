  ...
  <div class="min-h-screen bg-black-900">
    <div class="absolute left-0 top-0 w-full">
      <div class="flex flex-wrap justify-between items-center py-6 container">
        ...
        <div>
          <Button text="Go back home" @click="$router.push('/')" btnClass=" btn-outline-dark btn-sm" />
        </div>
      </div>
    </div>
    <div class="container">
      ...
      >
        ...
        <h4 class="text-3xl font-medium text-white mb-2">
          We are under maintenance.
        </h4>
        <p class="font-normal text-base text-slate-300">
          ...
          <div>
            <ul class="flex md:justify-start justify-center space-x-3">
              <li>
                <a
                  href="#"
                  class="text-slate-400 text-sm transition duration-150 hover:text-slate-900"
                  >Privacy policy</a
                >
              </li>
              <li>
