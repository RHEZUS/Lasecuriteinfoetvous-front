<template>
  ...
  import DropEvent from "./Analytics-Component/DropEvent.vue";
  import Etable from "./Analytics-Component/Etable.vue";
  import Map from "./Analytics-Component/Map2.vue";
  import Products from "./Analytics-Component/Products.vue";
  import SelectMonth from "./Analytics-Component/SelectMonth.vue";
  import Breadcrumb from "./Analytics-Component/Breadcrumbs.vue";
