<template>
    <div>
      <div class="flex h-fit justify-between flex-wrap items-center py-2">
        ...
        <div class="modal-groups">
          <CategoryModal :load-data="FetchData" :formMode="formMode" :user="item" ref="formModal1"></CategoryModal>
  ...
  import CategoryModal from "./CategoryFormModal.vue";
  ...
  export default {
    ...
    methods: {
        async FetchData(){
            await apiClient.get(`/api/admin/forum/categories`, { withCredentials: true })
            .then((response) => {
        ...
        async deleteItem(itemId) {
          await apiClient.delete(`/api/admin/forum/category/delete/${itemId}`, { withCredentials: true })
          .then((response) => {
              ...
              this.toast.error('Failed to delete Category', { timeout: 2000 });
              console.log(error);
          });
        },
    },
