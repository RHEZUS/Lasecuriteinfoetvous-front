<template>
    <div class="modal-groups">
        <Modal :showLabel="false" :title="formMode === 'create' ? 'Create New Tag' : 'Update Tag'" 
    ...
    methods:{
        ...
        createUser(){
            ...
            schema.validate({
                ...
                apiClient.post(`/api/admin/forum/tag/create`, this.form, {withCredentials:true})
               .then(response => {
        ...
        updateUser(){
            ...
            schema.validate({
                ...
                apiClient.put(`/api/admin/forum/tag/update/${this.form.id}`, this.form)
               .then(response => {
                    this.$refs.modal1.closeModal();
                    this.toast.success("Registered successfully", { timeout: 2000 });
                    this.resetForm();
