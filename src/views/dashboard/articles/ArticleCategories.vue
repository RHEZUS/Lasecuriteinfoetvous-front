...
export default {
  ...
  methods: {
      async FetchData(){
          await apiClient.get(`/api/admin/article/categories`, { withCredentials: true })
          .then(response => {
      ...
      async deleteItem(itemId) {
        await apiClient.delete(`/api/admin/story/category/delete/${itemId}`, { withCredentials: true })
        .then((response) => {
