<template>
    <div class="modal-groups">
        <Modal sizeClass="max-w-5xl" :showLabel="false" :title="formMode === 'create' ? 'Create New Story' : 'Update Story'" 
               label="Create Story" labelClass="btn-outline-primary h-10 flex items-center" 
               ref="modal1" themeClass="bg-primary-500">
            <form @submit.prevent="formMode === 'create' ? createStory() : updateStory()"  class="text-base text-slate-600 dark:text-slate-300  grid grid-cols-12 gap-3 items-center">
                <div class="col-span-12 sm:col-span-6">
                    <Textinput  type="text" placeholder="Story title"
...
export default defineComponent({
    ...
    methods:{
        ...
        async FetchCategories(){
          await apiClient.get(`/api/admin/story/categories`)
          .then((response) => {
        ...
        createStory(){
            ...
            schema.validate({
                ...
                apiClient.post(`/api/admin/story/create`, this.form, {
                    headers: {
               ...
               .then(response => {
                ...
                } else if (error.path === 'text') {
                    this.TextError = error.errors[0];
        ...
        updateStory(){
            ...
            schema.validate({
                ...
                apiClient.post(`/api/admin/story/update/${this.form.id}`, this.form, {
                    headers: {
                        'Content-Type': 'multipart/form-data'
                    }
                })
