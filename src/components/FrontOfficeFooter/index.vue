...
<footer class="bg-zinc-50 text-center text-surface/75 dark:bg-neutral-700 dark:text-white/75 lg:text-left">
    ...
    <div class="bg-black/5 p-6 text-center">
        ...
        <a class="font-semibold" href="https://tw-elements.com/"> LASECURITEINFOETVOUS</a>
    </div>
</footer>
</template>
<script>
...
export default {
    ...
    methods:{
        async getStoryCategories(){
          await apiClient.get(`/top/story/categories`)
          .then(response => {
              this.StoryCategories = response.data.categories;
